                                ...
                                <nav aria-label="Page navigation example">
                                    <ul className="pagination justify-content-center">
                                        <li className="page-item">
                                            <a className="page-link" href="RegPg2" tabindex="-1">Previous</a>
                                        </li>
                                    ...
                                    <li class="page-item"><a class="page-link" href="RegPg5">5</a></li> */}
                                        <li className="page-item">
                                            <a className="page-link" href="RegPg4">Next</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
